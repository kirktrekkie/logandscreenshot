...
class LogAndScreenshot():
    ...
    def read_settings_file(self):
        try:
            ...
            logging.warning("Settings file not found. %s"%e)
    ...
    def set_parameters(self,parameter):
        ...
        if temp[0] == "path":
            ...
            logging.warning("Unknown parameter: %s" %(temp[0]))
    ...
    def iterations(self):
        ...
        logging.info("iterationstotal: %d" %self.iterationstotal)
    ...
    def file_name_and_path(self):
        ...
        logging.debug("totalpath: " + self.filepathname)
    ...
    def take_out_computer_info(self,proc):
        try:
            ...
            logging.info("Process not found. %s" %e)
...
if __name__ == '__main__':
    ...
    for i in range(logger.iterations()):
        ...
        logging.debug("end-start: %s" %(end-start))
        if end-start < 3:
            sleep(3-(end-start))